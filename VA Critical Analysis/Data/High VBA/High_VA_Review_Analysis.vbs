...
Worksheets("High_VA_Review_Analysis").Delete
Sheets.Add After:=ActiveSheet
ActiveSheet.Name = "High_VA_Review_Analysis"
Application.DisplayAlerts = False
Set PSheet = Worksheets("High_VA_Review_Analysis")
Set DSheet = Worksheets("High_VA_Review")
...
TableName:="HighAnalysisPivotTable")

'Insert Blank Pivot Table
Set PTable = PCache.CreatePivotTable _
(TableDestination:=PSheet.Cells(1, 1), TableName:="HighAnalysisPivotTable")

'Insert Row Fields
With ActiveSheet.PivotTables("HighAnalysisPivotTable").PivotFields("Name")
.Orientation = xlRowField
.Position = 1
End With

With ActiveSheet.PivotTables("HighAnalysisPivotTable").PivotFields("Ownership")
.Orientation = xlRowField
.Position = 2
End With

'Insert Column Fields
With ActiveSheet.PivotTables("HighAnalysisPivotTable").PivotFields("Month")
.Orientation = xlColumnField
.Position = 1
End With

'Insert Data Field
With ActiveSheet.PivotTables("HighAnalysisPivotTable").PivotFields("Host")
...
Set PTable = ActiveSheet.PivotTables("HighAnalysisPivotTable")
...
Application.CutCopyMode = False
    ActiveSheet.PivotTables("HighAnalysisPivotTable").PivotSelect "", xlDataAndLabel, True
...
With ActiveSheet.PivotTables("HighAnalysisPivotTable").PivotSelect
